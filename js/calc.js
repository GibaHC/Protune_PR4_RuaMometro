...
// ---- Impressão digital de conteúdo (detecção de arquivo duplicado) ----
// Hash rápido de 53 bits (variante cyrb53) sobre o texto bruto do arquivo — não é
// criptográfico, não precisa ser: só precisa detectar duplicata acidental (mesmo arquivo
// solto duas vezes, ou renomeado), não resistir a alguém tentando forjar colisão de propósito.
// Passe único sobre a string, O(n), rápido o bastante pra rodar em cima de um CSV de alguns MB
// sem atraso perceptível — e roda em cima do texto que a leitura do arquivo já traz pronto,
// não é uma leitura extra.
